...
Isso significa que múltiplas tarefas podem
...
O mesmo não foi necessário para \texttt{y},
pois essa variável só é acessada dentro de uma thread, ou seja,
não há condição de corrida para \texttt{y}.
